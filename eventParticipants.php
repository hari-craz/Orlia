...
<body>
    ...
    <div class="admin-body">
        ...
        <main class="admin-main">
            ...
            // Solo
            $solo_q = "SELECT * FROM soloevents WHERE events='$eventKey' ORDER BY id ASC";
            ...
            // Group
            $group_q = "SELECT * FROM groupevents WHERE events='$eventKey' ORDER BY id ASC";
            ...
            <div class="filters-bar" style="margin-bottom: 20px;">
                <label for="typeFilter" style="font-weight: 500; margin-right: 10px; color: var(--text-main);">Filter by
                    Type:</label>
            ...
            const pdfConfig = {
                ...
                customize: function (doc) {
                    ...
                    doc.header = function (currentPage, pageCount, pageSize) {
                        ...
                        // 1. Watermark removed from header (moved to background)

...
<body>
  ...
  <a href="day2.php" class="view-day-btn">
    View Day 2 <i class="ri-arrow-right-line"></i>
  </a>
    ...
    <div class="events-container">
      ...
      if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="event-header">
              <div class="event-header-row">
                <div class="event-time">
                  ...
                  <!-- Time would go here if available in row -->
                </div>
          ...
          <?php if (!empty($rulesList) && !empty($rulesList[0])): ?>
            <!-- Rules Modal -->
